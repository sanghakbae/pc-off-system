...
if (isStaticHost) {
  ...
  window.fetch = async (input, init = {}) => {
    ...
    if (url.pathname === '/api/anomalies') return json({ ok: true, anomalies: [{ ts: baseNow - 3600000, hostname: 'shbae-PC', type: 'short_work', reasons: ['단시간근무'], presentSec: 10620 }] });
